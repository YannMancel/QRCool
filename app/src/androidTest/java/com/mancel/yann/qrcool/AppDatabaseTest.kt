...
class AppDatabaseTest {
    ...
    @Test
    fun insert_then_get_textBarcode_shouldBeSuccess() {
        ...
        // BEFORE: Add barcode
        val ids = this._barcodeDAO.insertTextBarcodes(barcode)
        ...
        val barcodes = LiveDataTestUtil.getValue(this._barcodeDAO.getTextBarcodes())
    ...
    @Test
    fun insert_then_get_wifiBarcode_shouldBeSuccess() {
        ...
        // BEFORE: Add barcode
        val ids = this._barcodeDAO.insertWifiBarcodes(barcode)
        ...
        // THEN: Retrieve barcode
        val barcodes = LiveDataTestUtil.getValue(this._barcodeDAO.getWifiBarcodes())
    ...
    @Test
    fun insert_then_get_urlBarcode_shouldBeSuccess() {
        ...
        // BEFORE: Add barcode
        val ids = this._barcodeDAO.insertUrlBarcodes(barcode)
        ...
        // THEN: Retrieve barcode
        val barcodes = LiveDataTestUtil.getValue(this._barcodeDAO.getUrlBarcodes())
    ...
    @Test
    fun insert_then_get_smsBarcode_shouldBeSuccess() {
        ...
        // BEFORE: Add barcode
        val ids = this._barcodeDAO.insertSMSBarcodes(barcode)
        ...
        // THEN: Retrieve barcode
        val barcodes = LiveDataTestUtil.getValue(this._barcodeDAO.getSMSBarcodes())
    ...
    @Test
    fun insert_then_get_geoPointBarcode_shouldBeSuccess() {
        ...
        // BEFORE: Add barcode
        val ids = this._barcodeDAO.insertGeoPointBarcodes(barcode)
        ...
        // THEN: Retrieve barcode
        val barcodes = LiveDataTestUtil.getValue(this._barcodeDAO.getGeoPointBarcodes())
